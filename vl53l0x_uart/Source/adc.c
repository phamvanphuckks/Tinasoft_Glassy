...
/**
  * @brief  Get the battery percentage value of the circuit
  * @param  none
	* @return specifies level pin
	*				@example : 91-99% <=> level is 9
	*				@example : 81-89% <=> level is 8
  * @retval None
  */
uint8_t Get_Pin(void)
{
	...
	return (uint8_t) ((adc_value*100)/4096)/10;
}
