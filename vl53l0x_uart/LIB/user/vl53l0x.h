/**
  ...
  * @date    2020
  * @brief   This file contains all the functions prototypes for the vl53l0x
  *          firmware library functions (add-on to CMSIS functions).
  *********************************************************************************************
  * @attention
  * This file is used to declare function
  * prototypes for the  vl53l0x  sensor
...
static bool setVcselPulsePeriod(vcselPeriodType type, uint8_t period_pclks);
...
static inline void setTimeout(uint16_t timeout);
static inline uint16_t getTimeout(void);
static bool   timeoutOccurred(void);
